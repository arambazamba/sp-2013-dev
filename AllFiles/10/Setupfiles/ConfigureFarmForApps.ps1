#Variables
$appHostDomain = "contosoapps.com"
$serviceAppPoolName = "SharePointServicesPool"
$password = ConvertTo-SecureString -string "Pa`$`$w0rd" -asPlainText -force
$webAppAccount = "CONTOSO\SPContent"
$servicesAccount = "CONTOSO\SPServices"
...
Write-Host
Write-Host "Verifying services are started..." -ForegroundColor White
...
Write-Host
Write-Host "Setting the SharePoint 2013 app domain..." -ForegroundColor White
...
Write-Host
Write-Host "Verifying the SharePoint App Management Service is running..." -ForegroundColor White
...
if ($appMgmtSvcInstance.Status -ne "Online") {
  ...
  Write-Host "SharePoint App Management Service is aleady running" -ForegroundColor Gray 
}



Write-Host
Write-Host "Verifying the SharePoint Subscription Settings Services is running..." -ForegroundColor White
...
if ($appSubSettingSvcInstance.Status -ne "Online") {
  ...
  Write-Host "SharePoint Subscription Settings Service is aleady running" -ForegroundColor Gray 
}



Write-Host
Write-Host "Getting Application Pool for hosting service applications..." -ForegroundColor White
...
Write-Host
Write-Host "Creating Subscription Settings Service Application..." -ForegroundColor White
...
Write-Host
Write-Host "Creating App Management Service Application..." -ForegroundColor White
...
Write-Host
Write-Host "Recycling IIS..." -ForegroundColor Gray 
IISRESET
Write-Host

Write-Host
Write-Host "Finished configuring farm for apps." -ForegroundColor Green
Write-Host
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU1Cv7QOd9fUR/Zw/if759iVKa
# Y9ygghWCMIIEwzCCA6ugAwIBAgITMwAAADPlJ4ajDkoqgAAAAAAAMzANBgkqhkiG
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFIoZ
# CXo6iISD46bRv179NutTvcRiMF4GCisGAQQBgjcCAQwxUDBOoCaAJABNAGkAYwBy
# AG8AcwBvAGYAdAAgAEwAZQBhAHIAbgBpAG4AZ6EkgCJodHRwOi8vd3d3Lm1pY3Jv
# c29mdC5jb20vbGVhcm5pbmcgMA0GCSqGSIb3DQEBAQUABIIBAN0eb8nehi5ERmeP
# vFTh0JaDxnC9Qw2IRvgFjFV+G9nKjmFc9KFfGLO3prF75d8X3XxOnEzMli9iksjp
# cYUfwdUhU0NTpz0ePO04AsieMMxIVs+3csSR8kbJ9At2u3mtglqOjWDNp75cHUrU
# c0KWo8UaR/ku+zMpmmuLVrK+K2UIMlclTBySrGCIuNIDOTnuOgI/48RzPN6ySptm
# aejDGaja7Ur/2+ur6B0j0GphTIUc3reXLJFh2U1qa2jnHS20z1PSpUnz7bdE4gAs
# h35Oj9zFoNJw04rRO+ALgYdvJROMjvDjdKMb56v+AVcH08YIMnuhRRcxPV2N0mGd
# uaoGn36hggIoMIICJAYJKoZIhvcNAQkGMYICFTCCAhECAQEwgY4wdzELMAkGA1UE
...
# MDExODAwNDdaMCMGCSqGSIb3DQEJBDEWBBQ4gYTX8dPUTWleFqLO+yAQtlGXgjAN
# BgkqhkiG9w0BAQUFAASCAQBl78zidCCK/wmqCqzLIje4T1G6/R3WSA3BH6wLFawG
# xY+4rzR2Xc3tscRI4XM4xkLx3gq69ZiqzxEbMoM4JxbZmErby4xKr3tk4hk/2RDb
# Z1xq2BFv3vVn7hiDelm0eOmeHq5tLyVq6NGPCPoMUlmruy867arBgpsWj87cn2Cb
# PFpksUJuJd9Erqg6DyQvbu5x2USDMsE8CQHVtHOzc4gbAzUmuTrD82V3qAgLmzHV
# 4XUGXb1xjRMCFC64ZyMVI7dcGlBChpoVThwtp3Y9YJmtiFndvu1f2Zt7a2VLX9fL
# HikyDPHJaNJK7qJrz1x9nEFhyMZKDNgtFya1DuHjQnV5
