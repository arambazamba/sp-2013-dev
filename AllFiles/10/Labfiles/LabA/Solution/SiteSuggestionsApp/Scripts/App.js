...
function onGetSuggestionsSuccess(sender, args) {
    var htmlToRender = [];
    ...
    while (suggestionEnumerator.moveNext()) {
        ...
        htmlToRender.push('<a onclick="displaySuggestion(');
...
function onGetSuggestionsFail(sender, args) {
    alert('Failed to get user name. Error:' + args.get_message());
}

function displaySuggestion(suggestionId) {
...
function onDisplaySuggestionSuccess(sender, args) {
...
function onDisplaySuggestionFail(sender, args) {
...
function onCreateSuggestionSuccess() {
    //Nothing to do here.
}

function onCreateSuggestionFail(sender, args) {
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFFKmQ5YFbuUY
// SIG // fbLhFgp3rAQ6mvEToIIVgjCCBMMwggOroAMCAQICEzMA
...
// SIG // BgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBRfT12p+hcT
// SIG // BQ61SPk82N9DopDfGDBeBgorBgEEAYI3AgEMMVAwTqAm
// SIG // gCQATQBpAGMAcgBvAHMAbwBmAHQAIABMAGUAYQByAG4A
// SIG // aQBuAGehJIAiaHR0cDovL3d3dy5taWNyb3NvZnQuY29t
// SIG // L2xlYXJuaW5nIDANBgkqhkiG9w0BAQEFAASCAQBOQvdN
// SIG // UGgshrzAVf82yFoJKZGsAlKkfzenrrCsqSwuHEUtvx/B
// SIG // x/88DC855K5wQIl4JK2AtZNwCKq6S23VZYGGTRJ1G4TA
// SIG // uxliz/NFDRgYcherS8+bbsEWZw+eU7NcbWzigBbUqTBG
// SIG // f9Fq/BVrY4pC3LnsYakw85ogXX9JfirCr6n7Ad3b088x
// SIG // M67/8YRMQCHFME/19HhLfndBR1f8tDuJ54WdKwiYp35o
// SIG // efhHsf1xZZFHyg7H+KvDv3BlGipSwtdF1ShDB5/lR5bY
// SIG // QEjBKzudgH4Fs5IHtl29CqZ6/WlxvtpMyzzwCDbk9ahC
// SIG // WwwGMx6BQtpG+giV52MO/hXXtBUwoYICKDCCAiQGCSqG
...
// SIG // DQEHATAcBgkqhkiG9w0BCQUxDxcNMTMwNzAxMTgwMDQz
// SIG // WjAjBgkqhkiG9w0BCQQxFgQUGzUMZV0KYo9tJUcq8TLi
// SIG // UDTV/lkwDQYJKoZIhvcNAQEFBQAEggEAKnh6DR380x6n
// SIG // sqM6BmunDKnZdyOIbJ7KinJ2xB6b7yLTERuvl9JzKN2T
// SIG // 00dtnO8Q/gsFKYxroWGy/Nlvdb+m8paGi6TBbsJM887/
// SIG // PuCClZSxVWUWVT3HSNj+C/ZFHybGTBKoPMPujWSC5cvi
// SIG // eSAK9So5V5NxpySLWSFFeOnh2VCNSHsUg7X5GoFph15w
// SIG // nvWkcSi6sQywInwaTkhAogL5ulKtABdtjA3I9kHwfZFF
// SIG // vh1rjFUd23uw4Xcl211uToUpQpp2xe2Ysc9v0QSAPunz
// SIG // Gkkz5+Nt7ONE2y/Vz4gI6/kU10dfhgbOIJKbrp3LsqOL
// SIG // byZNwKHFrta7NP1UsXHnRg==
