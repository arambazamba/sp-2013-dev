...
$(document).ready(function () {
    ...
    // TODO: Task 1. Get the SPListItemID token from the query string
    var customerID = getQueryStringParams("SPListItemId");
    getList(customerID);
});

// TODO: Task 2. Modify the getList function and the caml query
function getList(customerID) {
    ...
    clearInfo();
    var targetList = hostWebContext.get_web().get_lists().getByTitle("Orders");
...
function onSuccess() {
    ...
    if (list.get_count() != 0) {
        ...
        while (listEnum.moveNext()) {
            ...
            var row = table.insertRow(enumCount);

            for (var cellNum = 0; cellNum < 3; cellNum++) {
                cellArray[cellNum] = row.insertCell(cellNum);
            }

            var d = new Date();
            d = currentItem.get_item("Date");
            var day = d.getDate();
            var month = d.getMonth() + 1;
            var year = d.getFullYear();

            cellArray[0].innerHTML = currentItem.get_item("Order_x0020_Number");
            cellArray[1].innerHTML = month + "-" + day + "-" + year;
            cellArray[2].innerHTML = "$" + currentItem.get_item("Total_x0020_Amount");
            enumCount++;
        }

        var customerFullName = currentItem.get_item("Customer_x003a_Full_x0020_Name").get_lookupValue();
        $("#CustomerName").text(customerFullName);
        $("#TotalOrderNumber").text("Total number of orders: " + (enumCount - 1));
...
function onFail() {
    alert("List retrieval failed");
}

function clearInfo() {
    $("#OrderTable tbody tr").remove();
    $("#TotalOrderNumber").text("");
    $("#TotalAmount").text("");
}
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFDLX4SEh+VD1
// SIG // P1WzPXZDhI4TLrnWoIIVgjCCBMMwggOroAMCAQICEzMA
...
// SIG // BgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBRIz8Jcla5v
// SIG // 3sLbbgTWI8ZeXmvlmDBeBgorBgEEAYI3AgEMMVAwTqAm
// SIG // gCQATQBpAGMAcgBvAHMAbwBmAHQAIABMAGUAYQByAG4A
// SIG // aQBuAGehJIAiaHR0cDovL3d3dy5taWNyb3NvZnQuY29t
// SIG // L2xlYXJuaW5nIDANBgkqhkiG9w0BAQEFAASCAQCS6/Hb
// SIG // 8mucpqlCGrRxdA+A3D/LBDpUVMFfUClofEkV4N3f/qnE
// SIG // N64IL37eiYaqHYPSlZtfXf0ZH2HIu0YzXnjLD0qnT75f
// SIG // h8dXuBjq5EmPj/kJAfn9m4OFBjA49f7V8t2XWb8dOJs2
// SIG // UzibgWP1j67OIksXQpOt5V9Hnd+B1s9zNuZgi/SaWYc/
// SIG // NTVRu4B1jCPHOOYiS9MiBFhXi9qaoPLXqW2Wl1toZA/M
// SIG // 3ThXHn4hAnWbbZkJJPMuzTBvEl+YePDj3/MQN3TqojOS
// SIG // otqTFbn47ThVRFXBYQdezdbohzCalDt3XlG+93eW38bv
// SIG // wjn+psVShVLw4h2LMk4TsDh5dDrpoYICKDCCAiQGCSqG
...
// SIG // DQEHATAcBgkqhkiG9w0BCQUxDxcNMTMwNzAxMTgwMDU0
// SIG // WjAjBgkqhkiG9w0BCQQxFgQUqZcVfkQy0k2nL3DSoXfX
// SIG // fkCb9SkwDQYJKoZIhvcNAQEFBQAEggEANDeczecMkWuh
// SIG // 43udbCLmp+IZ/me7VFqtZvDfQ1TH1Fq0qBa8tGjtH7OC
// SIG // yg6muhMZW6/6fHrA10Dt/KkQE5aEzlp/M1K8+rDUkqFD
// SIG // uQOYxQ+UvYNWbgm31Oy2V+4U9LG6r3yoxzKkgZ9+gD2B
// SIG // 8lU5eumuClqXWt1c4DyjwgTM8JK4Ug88SOMWtsr1ksK0
// SIG // z/3kbFyoCRbafgTDMOJ0Q790LO+vNck/iNTTyWrvKl4Z
// SIG // xpVkoATpnnZRIk831WC/tIbPVjC8cips3NpRSN28eDfR
// SIG // BFAb730/G8zCuxH7a1Vs9lbfoNjybQDYBomWe0hEMD4j
// SIG // j68LJjAuIcfhWd/JUBS1rw==
