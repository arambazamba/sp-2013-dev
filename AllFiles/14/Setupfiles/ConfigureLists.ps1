...
Write-Host
$site = get-spsite "http://team.contoso.com"
$web = $site.OpenWeb()
$spFolder = $web.getfolder("List Template Gallery")
$spfilecollection = $spfolder.files
$customers = get-item ./Lists/customers.stp
$orders = get-item ./Lists/orders.stp
$spfilecollection.Add("_catalogs/lt/Customers.stp", $customers.OpenRead(), $true)
$spfilecollection.Add("_catalogs/lt/Orders.stp", $orders.OpenRead(), $true)

$listTemplates = $site.GetCustomListTemplates($web)
$web.Lists.Add("Customers", "", $listTemplates["Customers List"])
$web.Lists.Add("Orders", "", $listTemplates["Orders List"])

$spList = $web.Lists["Customers"]    #Get list instance
$spList.OnQuickLaunch = $True    #Set true to display in Quick Launch
$spList.Update()
$spList = $web.Lists["Orders"]    #Get list instance
$spList.OnQuickLaunch = $True    #Set true to display in Quick Launch
$spList.Update()
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUD4v2LUs3z5L33HOtaOA+Ln6t
# EfSgghWCMIIEwzCCA6ugAwIBAgITMwAAADQkMUDJoMF5jQAAAAAANDANBgkqhkiG
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFMJW
# yMZGLR8VEENMbLOJuozRE9czMF4GCisGAQQBgjcCAQwxUDBOoCaAJABNAGkAYwBy
# AG8AcwBvAGYAdAAgAEwAZQBhAHIAbgBpAG4AZ6EkgCJodHRwOi8vd3d3Lm1pY3Jv
# c29mdC5jb20vbGVhcm5pbmcgMA0GCSqGSIb3DQEBAQUABIIBADxiZoC/3qKChzkv
# 5n+kyt2BiZVpvk4LmMisYrpIM/F3mAk+Yeqz/PpI7Spp5SmjEFhOdOATDs1353QM
# cddO0LxqF9Fl38OnpQ0Y4nMH25BV/Y1JUoaLJlwt6udKxe19zgv11cf+aAlWoq79
# 0Y4kakmKuEXJtIQOxEx6m7ezE8EP/9qWtWFgiXOPnCuMGGVrQZWE2HwA0n8O/xZe
# kfqczqL36NHouBv86mDrhd7KGMmP2mnacCX8MxvL9kfD+JytxP4tp3Y4Q+SXDTsT
# kmCleLq52GqgTShTkmlYqNbvrXcM8/uExw7tczAptt1dTwVP4uLMNIcYRyPO2Pmi
# y7rYu0+hggIoMIICJAYJKoZIhvcNAQkGMYICFTCCAhECAQEwgY4wdzELMAkGA1UE
...
# MDExODAxMDFaMCMGCSqGSIb3DQEJBDEWBBR1bfFpkqlrUstDxhwmnvfyjX3MnTAN
# BgkqhkiG9w0BAQUFAASCAQCQT0O7/Mflh0ZNRWdDFx+aEBJaU0jUuFRORalbEa63
# R+wSACPaMlYZsGInRfJleAfAlAtdsxdL2/V+Sr1KOWMMAi9GzJVO5t4R1pL7PGO3
# 44sCFpzlRdPo3Rb9FscLCV9m5LZ2LZ1DLtThOyvAsfy5jmpJ4clBTxgHr05d9cvT
# +6rF9LNWvV134T3M/o52a/4m+bV3F8K/9uBeQl+T9GLGFKPtr5mmv+PzmoUwqeTA
# gXOJ9+4TKLuAAmW6yvgu6mfBZ2IDxobNNXmTYoTEW1f9wGfQ1xEYi+xJcFeZhw+3
# V3dh6mdUwvHgfSox9+RNLAyIScL2ZLbDRT46uuMdJJVK
