    ...
    public partial class Default : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            using (var clientContext = TokenHelper.GetS2SClientContextWithWindowsIdentity(hostWeb, Request.LogonUserIdentity))
            {
                ...
                clientContext.Load(regionsList);
                ...
                CamlQuery regionsQuery = new CamlQuery();
                Microsoft.SharePoint.Client.ListItemCollection regionItems = regionsList.GetItems(regionsQuery);
                ...
                {
                    SalesTable.Rows.Add(createRow(regionItem, saleItems));
                    PurchasesTable.Rows.Add(createRow(regionItem, purchaseItems));
                }
            }
        }
