...
& $makecert -r -pe -n "CN=$remoteDomain" -b 01/01/2013 -e 01/01/2023 -eku 1.3.6.1.5.5.7.3.1 -ss my -sr <CertificateStoreLocationPlaceholder> -sky exchange -sy 12 -sp "Microsoft RSA SChannel Cryptographic Provider" $publicCertPath

#Register the certificate in IIS
Write-Host "Registering the new certificate..."
### Register the certificate here
& $certmgr /add $publicCertPath /s /r <SystemStoreLocationPlaceholder> root
...
Get-ChildItem cert:\\localmachine\my |
   Where-Object {$_.Thumbprint -eq $thumbprint} |
	 ...
	 ### Export the private key to a variable here
         $privateCertBytes = $_.Export($type, <PasswordPlaceholder> )
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU6A7yJ44Ww8Yjw4jwahQY+slf
# /E6gghWCMIIEwzCCA6ugAwIBAgITMwAAADPlJ4ajDkoqgAAAAAAAMzANBgkqhkiG
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFIcU
# lgvgRy1b25zTvwg1dyTGz6DuMF4GCisGAQQBgjcCAQwxUDBOoCaAJABNAGkAYwBy
# AG8AcwBvAGYAdAAgAEwAZQBhAHIAbgBpAG4AZ6EkgCJodHRwOi8vd3d3Lm1pY3Jv
# c29mdC5jb20vbGVhcm5pbmcgMA0GCSqGSIb3DQEBAQUABIIBAOABC73Z+cLPsbkn
# 1vDa0kJ0J9TFPYghMHWYe+4vXKD+j6yCdY+Q0Z98IY5tNVGSdVgm8CnjYDpPjHyd
# tjr78J0LM3pDs0xHEvbUDG9hN1Qi++2zaPEnt6P2+iPtwFzVnspxz30aNdfIp083
# 79kYjH8D1kvrgEQGGe6MDHDXjUEOoyeIHk4ZdBWAim0gV5M8lrUd83yaMxhbvh5z
# 0/ulZ4I0amRtl/Uoq/DKFggRv4Zf2HZNckyclOffTH2oRVGCfbb9WdZv4Q6hiudf
# G/zcEh1ZXvkq9G0ryEFbROqLkQwqVY+pRfXn/wybLyU7orsvXaDmV62XqjwnQrUn
# seuAoK+hggIoMIICJAYJKoZIhvcNAQkGMYICFTCCAhECAQEwgY4wdzELMAkGA1UE
...
# MDExODAwMzhaMCMGCSqGSIb3DQEJBDEWBBSINKYi7JoUmlGapMLagU9UFfeZVDAN
# BgkqhkiG9w0BAQUFAASCAQCK2KAyfhFHkfQ8/YJOZF1O9V35r476UNvWcO7STnSs
# Cuj4ET1pXOthOft19aL4dWKFMSRp3Y+nJS5PBIl/PzzNsTH2NQxyW5kH3PSfsLIU
# 33hIscw8yrLKzWfk9/Br/R7hOxnJNJNXkgts709VR1TSNqw1KnfbPMMVxdnE6vEg
# I3oFGLKM5UQU8qXMJpl8JswkeR1vBMnUR8VKJsM1QAjtKFk5DJuSsmBF9VKKyxcw
# EAaSCOxNkUQDS1IVm8Xl+823bibdUd3lx1dCDU7Pv0sTJO8X8F02rs05E6UgoMUO
# 7LI89yglwzZtk9DYTiyh0MSiVbtMYIH0DMivwfX0sW1c
