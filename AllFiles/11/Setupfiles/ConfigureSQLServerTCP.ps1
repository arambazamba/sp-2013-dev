...
Write-Host
Write-Host "Configuring SQL Server to allow TCP/IP connections..." -ForegroundColor White
Write-Host
Write-Host "Loading SQL Server management assemblies..." -ForegroundColor Gray
Write-Host
...
Write-Host
Write-Host "Enabling the TCP protocol..." -ForegroundColor Gray
Write-Host
...
Write-Host "Stopping the database engine service..." -ForegroundColor Gray
Write-Host
...
Write-Host "Restarting the database engine service..." -ForegroundColor Gray
Write-Host
$dfltInstance.Start();
...
Write-Host "Finished configuring SQL Server protocols" -ForegroundColor Green
Write-Host
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU4WD2nVZs3LtlmjIVn1XYCW8a
# Y/qgghWCMIIEwzCCA6ugAwIBAgITMwAAADQkMUDJoMF5jQAAAAAANDANBgkqhkiG
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFBEQ
# 9IMi2c7AtR0JkKPGpBO+60alMF4GCisGAQQBgjcCAQwxUDBOoCaAJABNAGkAYwBy
# AG8AcwBvAGYAdAAgAEwAZQBhAHIAbgBpAG4AZ6EkgCJodHRwOi8vd3d3Lm1pY3Jv
# c29mdC5jb20vbGVhcm5pbmcgMA0GCSqGSIb3DQEBAQUABIIBACTtI1/EhIViZvPd
# U8i9TZToOeG1T5QklkpqKjT2HTZbFoHELEU9On8TF00x2g8hkl+mgdhCVKOhlbDk
# YgSbculgYQ5H/qs2oLF1gCy0v1QkL+FWM65IORiKQ1H7X0UHePQFFMuhcboA4s4l
# pYqqLWrn6AKm/kmYm2msBgQVCpYAFOtSt4JodfIA9YoATwcU0/LEvP0CRZVkUFbn
# VNPggO6wTKRBo4kUUYuLnTTpqn3B/942xVgJAWp+gYyewXzMD/k1ivxcXD+AafFx
# wmMFfvKbNxWrZh6FmVRLm+fpqg3vVwBy0c9AzSUgN32I+ZkGXlhVniH1TX8Q2ZHm
# 3ypF4M6hggIoMIICJAYJKoZIhvcNAQkGMYICFTCCAhECAQEwgY4wdzELMAkGA1UE
...
# MDExODAwNDhaMCMGCSqGSIb3DQEJBDEWBBQXcpq8irXYzhPuQPUh+nWH34Fj6zAN
# BgkqhkiG9w0BAQUFAASCAQBaYivDjOpVzttSrAgqH60YqLA1Wti+lpXRidM3xccb
# F/qt2MdfGFdogbv4Y2QYVQpEDLXWuYPiGBTKsTsjFohgt8KuJg9PvSnzzIFY40nu
# ySqLPXF7m1Sm10K1siwcU5Ufd0D0pTl+rMxMeFlS7JRTVeEp81d5trBpdwAbV/Xi
# sVVhhqjvoPOgwYlD4xv4Px06LFOCtI1qW2aLU14pxEcN4jEQ/Iug/H4RR20JgbWV
# HFpvfJppyaYfxyAawsBVLHa9acE9Lqj1PMCxrnCIhaBMDj0EKAD2mVm4Nk+nVNFI
# tj/ZnJ65wHPuspIGi0quK3hVWxYEjKdsO16ibi44AQtz
