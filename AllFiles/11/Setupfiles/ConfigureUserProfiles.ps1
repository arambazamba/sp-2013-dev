...
Write-Host
Write-Host "Verifying the User Profile Service is running..." -ForegroundColor White
$ups = Get-SPServiceInstance | ?{ $_.TypeName -eq "User Profile Service" }
if ($ups.Status -ne "Online") {
  Write-Host "User Profile Service is not running..." -ForegroundColor Gray 
  Write-Host "Starting User Profile Service..." -ForegroundColor Gray 
  $silence = Start-SPServiceInstance -Identity $ups
  Write-Host "User Profile Service started" -ForegroundColor Gray 
} Else {
  Write-Host "User Profile Service is aleady running" -ForegroundColor Gray 
}
...
Write-Host
Write-Host "Creating User Profile Service Application..." -ForegroundColor White
Write-Host "Creating User Profile Service Application..." -ForegroundColor Gray 
$upsa = New-SPProfileServiceApplication –ApplicationPool $appPoolServiceApps –Name "Contoso User Profiles"
Write-Host "User Profile Service Application created" -ForegroundColor Gray 
Write-Host "Creating User Profile Service Application proxy..." -ForegroundColor Gray 
$upsaProxy = New-SPProfileServiceApplicationProxy –ServiceApplication $upsa -Name "Contoso User Profiles" -DefaultProxyGroup
Write-Host "User Profile Service Application proxy created" -ForegroundColor Gray 

Write-Host "Finished configuring user profiles." -ForegroundColor Green
Write-Host
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUeog3HcVUeRBJIE51XjxD1xdD
# iKGgghWCMIIEwzCCA6ugAwIBAgITMwAAADQkMUDJoMF5jQAAAAAANDANBgkqhkiG
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFBqm
# dLN+j81fHg37bjJNHjRY2BSxMF4GCisGAQQBgjcCAQwxUDBOoCaAJABNAGkAYwBy
# AG8AcwBvAGYAdAAgAEwAZQBhAHIAbgBpAG4AZ6EkgCJodHRwOi8vd3d3Lm1pY3Jv
# c29mdC5jb20vbGVhcm5pbmcgMA0GCSqGSIb3DQEBAQUABIIBANbHqey/gpd55oss
# aVJ/jPmEanfQw5xbheELniC1fsFnD3co7flUxYhsTMDwHnNYsRAYieCmhHWYi9Jm
# lpU6EAYHT2Gi++/dKHk8m03bg0egrScFbY1mVgFy74fSEFtycgjGWI/BcMs/dJhc
# C3/+fHfVjtXNOaQEXT+QtPO56r60ks7V24E2JoDfdKkTe/aJO7DAYMmlyNQStegQ
# oXt2JPVOtG8IQBojXUAyepdVMBctoXJxHaVbQDczhP/AyytQ4+mxQdC/Axl6bQoM
# YxZuCafG3gaTJXQuU13E9dzwC/XQ4EaCjvVyrmX3iZs9k9ufQgmmJP4AaqNSv8WB
# 4LaSRJOhggIoMIICJAYJKoZIhvcNAQkGMYICFTCCAhECAQEwgY4wdzELMAkGA1UE
...
# MDExODAwNDlaMCMGCSqGSIb3DQEJBDEWBBQ0U1Q6/Vzdn2OkgVBT77PgNeDLCjAN
# BgkqhkiG9w0BAQUFAASCAQCPMOiL0E4G2F3fe7fUXs6zk9C8ullse99yeJGukHTJ
# nFLHxVxu3qNp5wpetVsZmd4wOfzF7vRDPl9jB/eSCJ0H1BMPmxpjH9jxkdaOs9i8
# bJ7G2PJjnkxcsmdqkePRs0uMcJjyZR7RI8q+sRrkdTnyb2uoLOXKZae+0IO9Shsa
# 9GrnKdmv19X5uKGkveDDGgajyfRkMXQgh8xZIUJ0uNPaxVLwM2PXyTb9JbMFrBzd
# PjGZG9i6vDUyYmIlue7gMYFDd9LyoFmXQxU5xfMpnnwQJZnUt5medNt2Qw5fR0KC
# Gk1I+7ufjViMMpxKCNFWUBgN6R2+el2ZS3JT7I76aPkw
