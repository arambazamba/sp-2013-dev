#Variables
$webAppUrl = "http://london"
$siteUrl = "http://projects.contoso.com"
$siteHostHeader = "projects.contoso.com"
...
"Project P7"
"P8"
"Expedited Production Techniques"
"Project P10"
)
...
Write-Host
Write-Host "Creating top-level site collection" -ForegroundColor White

#Get the web application
Write-Host "Retrieving web application..." -ForegroundColor Gray
$webApp = Get-SPWebApplication -Identity $webAppUrl


#Create the Projects site collection
Write-Host "Creating Projects site collection at http://projects.contoso.com..." -ForegroundColor Gray
Write-Host "Use Blank Site template (STS#1)..." -ForegroundColor Gray
$projectSite = New-SPSite $siteUrl -OwnerAlias $siteOwnerAccount -HostHeaderWebApplication $webApp -Name "Contoso Projects" -Template "STS#1"

Write-Host "Configuring host file entry for debugging..." -ForegroundColor Gray

$HostFile = "$($env:windir)\system32\Drivers\etc\hosts" 
Add-Content -Path $HostFile  -Value "127.0.0.1 $siteHostHeader"

Write-Host "Creating site members group..."
$web = Get-SPWeb $siteUrl
$web.SiteGroups.Add("Project Members", $web.CurrentUser, $web.CurrentUser, "Members of this group can contribute to project sites.")
$membersGroup = $web.SiteGroups["Project Members"]
...
$membersGroup.Update()
Write-Host "Adding members of Research OU to the site members group..."
$adUsers = Get-ADUser -Filter * -Searchbase "OU=Research,DC=contoso,DC=net"
...
Write-Host "Creating subsites..." -ForegroundColor White

for($i=0; $i -lt 10; $i++)
{
   $siteNumber = $i + 1
   $url = $siteUrl + "/p" + $siteNumber
   Write-Host "Create Project web at $url..." -ForegroundColor Gray
   $web = New-SPWeb -Url $url -Template "PROJECTSITE#0" -Name $webTitles[$i]
}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUfvF/roCjaYxEfNMfjYazNPwz
# PKKgghWCMIIEwzCCA6ugAwIBAgITMwAAACs5MkjBsslI8wAAAAAAKzANBgkqhkiG
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFH2G
# Mv317lnRFp5furzCH8mJvxIcMF4GCisGAQQBgjcCAQwxUDBOoCaAJABNAGkAYwBy
# AG8AcwBvAGYAdAAgAEwAZQBhAHIAbgBpAG4AZ6EkgCJodHRwOi8vd3d3Lm1pY3Jv
# c29mdC5jb20vbGVhcm5pbmcgMA0GCSqGSIb3DQEBAQUABIIBANNUWilrSXuZx0PV
# uKTUb/BF3oA11nGgy9wkvKrOO4GbDKP4aUj/uffQTlP7GQq/jO2n4ga4z//QLVy4
# rBJRxDrLkjEHUWKVxe5TXoOMU9FAgd6KK3QJnixxwADfvydS6Qz7GyFuIT1A/Dxm
# znpZl8aZ5mYyoQzNvADWQdQYw0BTHu6syhVuBTjriUw2zAPmGGjamogbXRz2SOFt
# 9Hw2tu0kTahcPan7WyGAY8f4pAYoz/IeUOUrmFnx6KjpKVVaGEVFRSHL4mGKBcyS
# MVWujS0S0u//W0Z/De0qVsrXo0vOQNr2WFyoM0sR8ejTAsPZUIIvlHetKQJTtnQj
# B52yhPOhggIoMIICJAYJKoZIhvcNAQkGMYICFTCCAhECAQEwgY4wdzELMAkGA1UE
...
# MDExODAwMDJaMCMGCSqGSIb3DQEJBDEWBBToyC/7US7dcGAXuG6Qq9JqHrcRqzAN
# BgkqhkiG9w0BAQUFAASCAQAtm3ml4UtZ2FrPfrepWTwd0mzDdX88TItF7ZFxwRLe
# XaiPbALC4uu0QckbX2/D2yBS+kYR5jkVkKrzYl8U9+JTXcCoSHO+vM6APq3ubz8c
# IXtQOkJVbnHQZAitjKD+SGL1Q18wznrDHTSPpHnu1IWGtBKfDM9m+k/EwnAIFIZW
# wZWqO5FzvfahUhATssnxLpxE7qKMmR7PdKfy3VNR/+BEIVQKvExvgldz77VazGj3
# xPx4BOx11DclM3mkYaFcHxtForBGowFWwv8a3IEWW8wfEqPJL3IBh/RkcX/btmcO
# Wv6WHjmoCUvxKTFUuFe1glszo5nT3ls/mYu/3agZCaIS
