...
Add-Content -Path $HostFile  -Value "127.0.0.1 www.contoso.com"
Add-Content -Path $HostFile  -Value "127.0.0.1 pain-relief.contoso.com"
Add-Content -Path $HostFile  -Value "127.0.0.1 anti-virals.contoso.com"
Add-Content -Path $HostFile  -Value "127.0.0.1 cosmetics.contoso.com"
...
$teamSite = New-SPSite http://sales.contoso.com -OwnerAlias $siteOwnerAccount -HostHeaderWebApplication $webApp -Name "Sales Team Site" -Template "STS#0"

Write-Host
Write-Host "Creating public facing site collection at http://www.contoso.com..."
$teamSite = New-SPSite http://www.contoso.com -OwnerAlias $siteOwnerAccount -HostHeaderWebApplication $webApp -Name "Contoso Team Site" -Template "BLANKINTERNET#0"

Write-Host
Write-Host "Creating team site collection at http://pain-relief.contoso.com..."
$teamSite = New-SPSite http://pain-relief.contoso.com -OwnerAlias $siteOwnerAccount -HostHeaderWebApplication $webApp -Name "Pain Relief Team Site" -Template "STS#0"

Write-Host
Write-Host "Creating team site collection at http://anti-virals.contoso.com..."
$teamSite = New-SPSite http://anti-virals.contoso.com -OwnerAlias $siteOwnerAccount -HostHeaderWebApplication $webApp -Name "Anti Virals Team Site" -Template "STS#0"

Write-Host
Write-Host "Creating team site collection at http://cosmetics.contoso.com..."
$teamSite = New-SPSite http://cosmetics.contoso.com -OwnerAlias $siteOwnerAccount -HostHeaderWebApplication $webApp -Name "Cosmetics Team Site" -Template "STS#0"
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUmGxhQ9XIzyQ/hVptck9Ar/FX
# 0F+gghWCMIIEwzCCA6ugAwIBAgITMwAAACs5MkjBsslI8wAAAAAAKzANBgkqhkiG
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFOrF
# oIZNzgEatPdb3DGNEQSUvpT3MF4GCisGAQQBgjcCAQwxUDBOoCaAJABNAGkAYwBy
# AG8AcwBvAGYAdAAgAEwAZQBhAHIAbgBpAG4AZ6EkgCJodHRwOi8vd3d3Lm1pY3Jv
# c29mdC5jb20vbGVhcm5pbmcgMA0GCSqGSIb3DQEBAQUABIIBAAoz4Aeeft9cGMQs
# 6sCWe3yXEctggxFpzyDLaCfB6QypuQFFeDm6BjH2qn1ZUkWwWiSpAXTTBdGnuw1d
# mQyZ3H/wwkVnKNhHRIcxeC0X+K7dXi6u1mY2xmv8MihaPZkHtJmpaLk8NjTa+gft
# X0Oyj50wGJgjAWRA3CHmubKgKTy7Jm+ySVJ1eZUltsQCWnbCrD2v+g4uRVeKrmNc
# XkVlqzqwNzko9D9zuS0K1biu6ehl9gjdOBU3e5wPphIIMSM0TDXO2YIJwLi1BVAE
# 1ifMUO1Ydwdra5kEmUHLhObI9xajtbQH8cwXsv0H/tkGbZCiXpvNxp8a5wBYRSDH
# NVpJp+6hggIoMIICJAYJKoZIhvcNAQkGMYICFTCCAhECAQEwgY4wdzELMAkGA1UE
...
# MDExODAwMTJaMCMGCSqGSIb3DQEJBDEWBBRQ9t7px3psEWL4EFB+uHHHL8D8TjAN
# BgkqhkiG9w0BAQUFAASCAQA1ApE/QJ63P7qG2dXGFIW89VHL1nEgo5WMviiAcU1b
# NX+SznWLOo9As9S2FwbTJFA4IhgmOuCLFAuoAs3CJQbYQGlx6LQ36h7FO7in7r2s
# 0neAxWov79v3z9EI2GG91a6Xui5zFgV4GWQWitUrkRcH+lpyEoKjHD22W06dLKhr
# jYMqLrE021kANNpc4irNGYwpVRw2TPE+S1i1Rn2k+fKviQ64MMnk/K/ZMeGqBRnY
# kKqh18WuaIO2KPNIeS4jWaak9iUHkqhRAg3RXOaeIkAw3prdlyCstcDlCnlOC3N3
# Xm6SiONXKHZlyhHKxnGwpETVt6uZ0iWhK+oXf11sfUWG
