...
Contoso.LoadItemsDemoApp = function () {
    ...
    var createDemoItems = function () {
        createDiscussionItem("Test Item 1", "This item has been created to test the load and loadquery methods.");
        createDiscussionItem("Test Item 2", "This item has been created to test the load and loadquery methods.");
        createDiscussionItem("Test Item 3", "This item has been created to test the load and loadquery methods.");
    };

    var createDiscussionItem = function (title, body) {
        //Get the discussion list
        var discussionList = context.get_web().get_lists().getByTitle('Discussion');
        context.load(discussionList);
        ...
        context.executeQueryAsync(onCreateDiscussionItemSuccess, onCreateDiscussionItemFail);
    };

    var onCreateDiscussionItemSuccess = function () {
        //Nothing to do here
    };

    var onCreateDiscussionItemFail = function (sender, args) {
        alert('Failed to create item. Error:' + args.get_message());
    };
    ...
    return {
        get_itemswithload: getItemsWithLoad,
        get_itemswithloadquery: getItemsWithLoadQuery,
        get_username: getUserName,
        create_demoitems : createDemoItems
    }
} ()
...
$(document).ready(function () {
    Contoso.LoadItemsDemoApp.get_username();
    Contoso.LoadItemsDemoApp.create_demoitems();
});
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFGlsd3nSIjSI
// SIG // IsZWY/GUJFL0B9A+oIIVgjCCBMMwggOroAMCAQICEzMA
...
// SIG // BgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBSiWR0WK3vv
// SIG // lHC0CmhX+qTdcy3imzBeBgorBgEEAYI3AgEMMVAwTqAm
// SIG // gCQATQBpAGMAcgBvAHMAbwBmAHQAIABMAGUAYQByAG4A
// SIG // aQBuAGehJIAiaHR0cDovL3d3dy5taWNyb3NvZnQuY29t
// SIG // L2xlYXJuaW5nIDANBgkqhkiG9w0BAQEFAASCAQABfGod
// SIG // h3SQrWOnnCILJu66ESBS3iTrtxnArMfTPNBhiAj7FJ7w
// SIG // F5QdaY+vuvG1riGlSiTrYm1Nwsme1VL5z7B03DZR3wjD
// SIG // N8w4wJ03/PyUbe5jIgYNfnmO8n7hdDWnEgN6raBufNKM
// SIG // xapUKMVLlUgjNtSLzZU56200adO/HQHz5oQec8lWnlyd
// SIG // 6ib5uc9pQBAcg0MvYkNUHKvGVGR4hKIEjsI/fkagGW9i
// SIG // eIhP5HLQxFyTKoD9qECuINIv0wu5v1uwHN0bu3JhJis6
// SIG // UujvZe9mF0JnWxt4G0flzm2JI3UfWDpVl1uj1PpfBzRI
// SIG // 2jBXCbb1Spe7TseyPilRSOwbwSUmoYICKDCCAiQGCSqG
...
// SIG // DQEHATAcBgkqhkiG9w0BCQUxDxcNMTMwNzAxMTgwMDE2
// SIG // WjAjBgkqhkiG9w0BCQQxFgQUa+nDl/kkvQiw9s7ulucB
// SIG // fFhNFBUwDQYJKoZIhvcNAQEFBQAEggEAnoRqzlWGHylC
// SIG // irfw2I/v6kHccp39+m+MXjmuwIUl5+i21dkw6OpNJxfb
// SIG // 6FrA8F+UCQ1E8u6ufVfyQzSU5QjOeIgn5wYgupVSu4TZ
// SIG // XQzXJ1WGfn9Fqo/nxhzoxaVIetf57tB/tWsL7EJYihNx
// SIG // dROomiKQztYFz93n+uvBfgVITihPVS5KUG1PfU7yZFtY
// SIG // ccD20liMNJsmeMCwrVlvZqHP/z3rutVKFcrWQb/KLIWJ
// SIG // DDpS6dFqHVmmXuT0dPAK9xlQ78Dqsf4bAJRHieSfseoW
// SIG // IMoNY3s7iwoJnTx9VyyAnqcD9P7lWrVJcQr4Xfv2Ep3g
// SIG // ASAS/DKdum0FXKMHYbYkxQ==
