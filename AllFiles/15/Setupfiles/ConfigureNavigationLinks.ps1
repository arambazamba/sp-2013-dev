#Variables
$siteUrl = "http://publishing.contoso.com"
...
function AddHeading($headingName,$headingURL)
{
    ...
    $headingNode = $CreateSPNavigationNode.Invoke($headingName, $headingURL, [Microsoft.SharePoint.Publishing.NodeTypes]::Heading, $nodes)
    $web.Update()
}

function AddLink($headingName,$linkName,$linkURL)
{    
    $nodes = $pubWeb.Navigation.GlobalNavigationNodes
    $heading = $nodes | where {$_.Title -eq $headingName}
    $linkNode = New-Object Microsoft.SharePoint.Navigation.SPNavigationNode($linkName,$linkURL,$true)
    $heading.Children.AddAsLast($linkNode)
    $web.Update()
}

Write-Host
Write-Host "Configuring global navigation..." -ForegroundColor White
Write-Host "Adding manufacturing links..." -ForegroundColor Gray

AddHeading "Manufacturing" $siteUrl
AddLink "Manufacturing" "Analgesics" $siteUrl "True"
AddLink "Manufacturing" "First Aid Products" $siteUrl "True"

Write-Host "Adding legal links..." -ForegroundColor Gray

AddHeading "Legal" $siteUrl
AddLink "Legal" "Product Licensing" $siteUrl
AddLink "Legal" "Patents" $siteUrl
AddLink "Legal" "Contracts" $siteUrl

Write-Host "Adding IT links..." -ForegroundColor Gray

AddHeading "IT" $siteUrl
AddLink "IT" "Support" $siteUrl
AddLink "IT" "FAQs" $siteUrl
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUZRZvGmP59FQSAuSmoTmtFmUD
# 2Q+gghWCMIIEwzCCA6ugAwIBAgITMwAAADPlJ4ajDkoqgAAAAAAAMzANBgkqhkiG
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFAN7
# 67u+ZiuHaxTR05SYr2CDCGhWMF4GCisGAQQBgjcCAQwxUDBOoCaAJABNAGkAYwBy
# AG8AcwBvAGYAdAAgAEwAZQBhAHIAbgBpAG4AZ6EkgCJodHRwOi8vd3d3Lm1pY3Jv
# c29mdC5jb20vbGVhcm5pbmcgMA0GCSqGSIb3DQEBAQUABIIBANcQsWZ5aJefix8v
# 7/qVHvjWA7ox6HR0DsA+J8FUNV1KucszXeRGjuYKMd49WTVjScBqXCrF/aFLIMrV
# w03XG4kkJaXLnygxqAYnhwS3tZBhY8QOAEpH/kYI36d5ooej+qIYKVcuPtFDFm3v
# KEHFYtn8oFFLgxXxcHujdI4uRODBW6DrM9xblhxPnEFx22vNL+alAvEkUV07Hyk1
# 5efjjLlPNVFIMhy640EhZ6Q5MTvej1jPRiysN/sZrDzH+1gCazgJcxmieUhiMVSx
# jIyZbjp7tB+VrNE1npFLqC499wzcVOkhzJI1+3CcbxwZpnQRVvVzqjQ/ks7RIqRX
# DH24q2ahggIoMIICJAYJKoZIhvcNAQkGMYICFTCCAhECAQEwgY4wdzELMAkGA1UE
...
# MDExODAxMDFaMCMGCSqGSIb3DQEJBDEWBBS1YOutJC9vTdDSreGk1IzshnfsejAN
# BgkqhkiG9w0BAQUFAASCAQAf/LLSXI6Ntzh3icMSvpsUngjx8HP9MrekY55ynmip
# Fpp2hwpNEboaoiVkz3tVylmhN2VPFYGF6XTjywdZeJClEtgvD1jLIqVhVTT9TKEE
# +LoyHaKhjK78wQ1b17PmtZBYLSrmQ0IyGpmLvZdxdiSLYnfXi6ui3pKT4CfnkHyB
# RTAXwZDoqkdVcH5k7kefexu++b0s2t3W9/Ora+XD6e+rG1aixP2tCiseu1tzxjX6
# EqpmWADAurFBwXeDQbcPPqy6xo4EAYxtLSTm1iTGIrutWQRHSknFcRmMHOSfOA3i
# f2HuamnfWcGsHA7MTA7cZF9/n0s2k7fNPDBl1xoFxZnu
