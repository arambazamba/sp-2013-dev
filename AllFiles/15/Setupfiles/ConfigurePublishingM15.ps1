...
$siteTitle = "Contoso Publishing"
$siteHostHeader = "publishing.contoso.com"
$siteOwnerAccount = "CONTOSO\Administrator"
$siteTemplateID = "BLANKINTERNET#0"
...
#Create the Publishing site collection
Write-Host "Creating site collection at $($siteUrl)..." -ForegroundColor Gray
Write-Host "Using template $($siteTemplateID)..." -ForegroundColor Gray
$projectSite = New-SPSite $siteUrl -OwnerAlias $siteOwnerAccount -HostHeaderWebApplication $webApp -Name $siteTitle -Template $siteTemplateID
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUcdFraCP8ZPfPtU3jVPAF4nsR
# JwKgghWCMIIEwzCCA6ugAwIBAgITMwAAACs5MkjBsslI8wAAAAAAKzANBgkqhkiG
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFBII
# 9ogfdo5u24xXSaFfPAPoPUyUMF4GCisGAQQBgjcCAQwxUDBOoCaAJABNAGkAYwBy
# AG8AcwBvAGYAdAAgAEwAZQBhAHIAbgBpAG4AZ6EkgCJodHRwOi8vd3d3Lm1pY3Jv
# c29mdC5jb20vbGVhcm5pbmcgMA0GCSqGSIb3DQEBAQUABIIBAClAFXbtImaxrTUf
# /BDqc+iIbwk+EnKqnBts83y406kTAn+eCyumfjq6+zt/CYk5M5Sqp9XpwPImm0ZM
# Za1PXao/7xrGmp+JbZeZ2d1E+00bKDpR101QSf9COqROTIUI4oZv+e5jv/3QNzT1
# XR5xjNXVQHR664L3/J/zfenJ3phjTnKPbAOC2SAmu5FjG2PMR3tFsS5rLBedd7Jj
# OrzWfRyelpnTBvYS5I1hYA+pOabc4MXLCW/WVMMdfwW9ABwmoJOIKjjphy2ghani
# XK2CM6Ie/4mzA5rvlYmqdut+a2XKH6Hs9pP/sMmYyE48hifp3Zi5tE6r8VEKa4e1
# 6/3s+OChggIoMIICJAYJKoZIhvcNAQkGMYICFTCCAhECAQEwgY4wdzELMAkGA1UE
...
# MDExODAxMDFaMCMGCSqGSIb3DQEJBDEWBBRTZRYwZ7TmMq84ghNcwt5w8vXc3zAN
# BgkqhkiG9w0BAQUFAASCAQASZlr7Z/f+eZbVZvQV2hQ0JyNHTJZZkblIIctPJjyw
# JscDWgBa3AWfIiMMOLavUUror+WYMSmB1u3qYB/UhPmpsHwuzSUCMPhnJZhj5N/a
# nx8TZPhdlSFZeLHMVKyoGdxVUujLMeQFfclf8Ow9+mvzz4qCa7PZPpfTLON4QkUz
# UDH9XwSvtFffLUgdiZ+y06tCJyoSvCbibrNXC2iel84edWnuFTf4WDHDneYJenjL
# 2UEHKTzFeZLCY2+LbXzfxSVmvc9e4aUTThbsvlcbjrRVy5yhgx2wPASG7Piel5+H
# BFGeFE9N2tBp0HgjfBFY5au8Fn88OiH9Z0sp0VIWhfEz
