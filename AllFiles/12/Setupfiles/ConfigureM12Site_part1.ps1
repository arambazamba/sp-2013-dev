...
$siteUrl = "http://hr.contoso.com"
$siteHostHeader = "hr.contoso.com"
$siteOwnerAccount = "CONTOSO\Administrator"
$wspPath = "E:\Setupfiles\M12LabSetup.wsp"
$wspName = "M12LabSetup.wsp"
...
Write-Host "Creating HR site collection at http://hr.contoso.com..." -ForegroundColor Gray
Write-Host "Use Team Site template (STS#0)..." -ForegroundColor Gray
$projectSite = New-SPSite $siteUrl -OwnerAlias $siteOwnerAccount -HostHeaderWebApplication $webApp -Name "Contoso HR" -Template "STS#0"
...
$web.SiteGroups.Add("HR Members", $web.CurrentUser, $web.CurrentUser, "Members of this group can contribute to the Finance site collection.")
$membersGroup = $web.SiteGroups["HR Members"]
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUxGqdzz3uowD0EijQuQuZBzc7
# xF+gghWCMIIEwzCCA6ugAwIBAgITMwAAADQkMUDJoMF5jQAAAAAANDANBgkqhkiG
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFFZa
# yDHEVco2vTo5uYbgGrr+aPHxMF4GCisGAQQBgjcCAQwxUDBOoCaAJABNAGkAYwBy
# AG8AcwBvAGYAdAAgAEwAZQBhAHIAbgBpAG4AZ6EkgCJodHRwOi8vd3d3Lm1pY3Jv
# c29mdC5jb20vbGVhcm5pbmcgMA0GCSqGSIb3DQEBAQUABIIBAETrbq7AjRrQdGqz
# 0bXajpWhr+SKAL/Xr1+/9nLjfwsmdgCNveXcnGeX3dOj6wPeOjnxQ2XMD87FogIX
# vMgsAZqvRqf4J2GkqULVVla6Uht0bRnxGlSE+KcebQrrSv3+JXWBuV2ojBURq20u
# jSCgKMNbDxHveppfSxgsQIR8I6r+4VCUjNXDz8218iQqIqQYxKPuAuc/60dbQl6V
# 3Ku1h53MXuMiJy4tjLrtfwiwTykLzwswQQmHtI8bg0VATXL/cUKcnvDimlATDoNQ
# ZYredpa9u6a+nSlBGk8WFKrlB3KxMl9fgrisphrpDBIs35qE7qQhwtxbKcVaJ/V7
# /voX8tmhggIoMIICJAYJKoZIhvcNAQkGMYICFTCCAhECAQEwgY4wdzELMAkGA1UE
...
# MDExODAwNTBaMCMGCSqGSIb3DQEJBDEWBBT26HuIqFkoXJsniX9yMgzWC9bChjAN
# BgkqhkiG9w0BAQUFAASCAQAOrSNhzTiUj5fcz6jSmqg7XE41MYcyC8jJFpiVpN1d
# QG5iExvJs/jVnlOcdtK0StSCBgwRhoS2eCaV0T+Y9x0ZQ5B8hUbrc3uaChkbNq5M
# h85G7Ib2ltr2SAS9bjz4qNLQ05Ak6zrX/rxpUMVC7tURgyQWUfmpbVtW4GwkxApP
# OSFusk13Le4kV0my3uR73xxiE0wznSSM9jVe7wpQZBP945xOwfkgCUpjnRINTojZ
# XzSr+aauRu4chKkyleazvlu2yuABM7P89ZQGX+Khr8yND9bYqZD8APLL25JNJaOQ
# lJp+LxazfGXh1lpacPmWEiUCd6gTPJbQ6+cA+Ilip6Io
