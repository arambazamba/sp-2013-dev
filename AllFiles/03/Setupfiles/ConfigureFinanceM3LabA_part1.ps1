...
$siteHostHeader = "finance.contoso.com"
$siteOwnerAccount = "CONTOSO\Administrator"
$wspPath = "E:\Setupfiles\M3LabASetup.wsp"
$wspName = "M3LabASetup.wsp"
$featureName = "M3LabASetup_M3LabASetup"
...
Write-Host "Creating Finance site collection at http://finance.contoso.com..." -ForegroundColor Gray
Write-Host "Use Team Site template (STS#0)..." -ForegroundColor Gray
$projectSite = New-SPSite $siteUrl -OwnerAlias $siteOwnerAccount -HostHeaderWebApplication $webApp -Name "Contoso Finance" -Template "STS#0"
...
$web.SiteGroups.Add("Finance Members", $web.CurrentUser, $web.CurrentUser, "Members of this group can contribute to the Finance site collection.")
$membersGroup = $web.SiteGroups["Finance Members"]
...
$membersGroup.Update()
Write-Host "Adding members of Managers OU to the site members group..."
...
Write-Host
Write-Host "Installing lab resources..." -ForegroundColor White
Write-Host "Adding solution $($wspName) to the farm..." -ForegroundColor Gray
Add-SPSolution -LiteralPath $wspPath
Write-Host "Installing solution $($wspName)..." -ForegroundColor Gray
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU5H9UPMdFnjyjvpO7oZWmnSXv
# 9IKgghWCMIIEwzCCA6ugAwIBAgITMwAAADPlJ4ajDkoqgAAAAAAAMzANBgkqhkiG
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFPxq
# 59YeVPcTw0gRTLedy4m/Dj0UMF4GCisGAQQBgjcCAQwxUDBOoCaAJABNAGkAYwBy
# AG8AcwBvAGYAdAAgAEwAZQBhAHIAbgBpAG4AZ6EkgCJodHRwOi8vd3d3Lm1pY3Jv
# c29mdC5jb20vbGVhcm5pbmcgMA0GCSqGSIb3DQEBAQUABIIBANfse81ZfxawIya7
# I/mCIFyhDMZB/HDfWYsARADJ5bryAe+XxPsNd1GDTCQdCKMyiXBysVKBZal3u/55
# 5cYU2gZV9grZR5hRoJVW7mkW/9r9xM/v1Q0q198qxGDNjXuusgE/S27uRhxYVR69
# EtWSAWO5VNerFDF/Hd9V3j0U0tZbPJ5Y1+r4Hah/ddWtsJrtvN69RrtLD4O8GGAX
# boKZXt/0yuaEShdwfuXiF4i9ioIxX4Wfo79Mf3fPfGj1N0VuguY2ZfYgsNYcwrK3
# VRyjuChTE0VXnEaO6AcyDiYVGa8sf727m0RqHjVg1+8BdcbXBLdXnIAW0Wu4hr38
# gTnPhU6hggIoMIICJAYJKoZIhvcNAQkGMYICFTCCAhECAQEwgY4wdzELMAkGA1UE
...
# MDExODAwMDRaMCMGCSqGSIb3DQEJBDEWBBRH9/X2r44zlGner23pcjj80vrYDzAN
# BgkqhkiG9w0BAQUFAASCAQCTzyFKzaUD3qZ6oxY6kJRaRd6rWRjE9mieGroVvH4m
# kxUY6EcbNU+U1k4edso8F5b+gqgMecTO4pnnuZiSQeXrjRtEUDuplkYmouUu2OI6
# VXndLTrKFSzk4yvD4OOaN7eu3T0B1BcVhLELkkhN60un1AuV8dta95ozRjDg0dpA
# 7nIGNOItHwDjhbpCUKVF8rUeVQ0Ypi/gd9WgMTTJan37BHS5V7IyFXQ6axKCjbSp
# QR3kohf+aoFyd5iS7AA2XoS4iW7O7/RhuTDgweiGZYzxD9CzsoJTGSenp5/B60Vs
# YpckiSF+yv1Py8BSOD+IYg8pEoKxJkQviBpcAa+Ni1ki
